...
$(document).ready(function() {
    ...
    $('#rf_custom_add_to_cart_box').append($('.woocommerce-variation-add-to-cart .quantity'))
    $('#rf_custom_add_to_cart_box').append($('.woocommerce-variation-add-to-cart .single_add_to_cart_button'))
    ...
    $(".rf_col_item.rf_variation").on("click", function(event) {
        ...
        //Изменияем данные
        const add_to_cart_btn = $(this).children('.rf_row_item').children('span.rf_add_to_cart')
