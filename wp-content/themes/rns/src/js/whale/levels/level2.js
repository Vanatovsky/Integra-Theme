...
export function raycasterListenerTextesLevel2(
  settings,
  scene,
  camera,
  raycaster,
...
автоматизации`,
  ...
  const text_1_plane_helper_mesh = new THREE.Mesh(
    new THREE.PlaneBufferGeometry(2, 0.5, 2),
...
ОЧИСТКИ СТОКОВ`,
  ...
  const text_2_plane_helper_mesh = new THREE.Mesh(
    new THREE.PlaneBufferGeometry(1.2, 0.4, 2),
    materialPlaneHelterText
  );
...
ОЧИСТКИ ВОДЫ`,
  ...
  const text_4_plane_helper_mesh = new THREE.Mesh(
    new THREE.PlaneBufferGeometry(1.5, 0.5, 2),
    materialPlaneHelterText
  );
...
КОТЕЛЬНЫЕ`,
  ...
  const text_5_plane_helper_mesh = new THREE.Mesh(
    new THREE.PlaneBufferGeometry(1.5, 0.5, 2),
    materialPlaneHelterText
  );
  ...
  animate_scale_texts = new TWEEN.Tween(level_2_text_group.scale)
    .delay(4000)
    .to({ x: 1, y: 1, z: 1 }, 1500)
  ...
  animate_rotation_texts = new TWEEN.Tween(level_2_text_group.rotation)
    .delay(4000)
    .to({ y: 0 }, 1500)
    .easing(TWEEN.Easing.Sinusoidal.Out)
    .start();
  ...
  text1DebugFolder
    .add(settings, "text_rotation_coeficent")
    .min(-10)
    .max(10)
    .step(0.01)
    .name("rotate_coef")
  ...
  text2DebugFolder
    .add(settings, "text_2_position_x")
    .min(-10)
    .max(10)
    .step(0.01)
    .name("x")
  ...
  text2DebugFolder
    .add(settings, "text_2_position_y")
    .min(-10)
    .max(10)
    .step(0.01)
    .name("y")
  ...
  text2DebugFolder
    .add(settings, "text_2_position_z")
    .min(-10)
    .max(10)
    .step(0.01)
    .name("z")
  ...
  text2DebugFolder
    .add(settings, "text_2_rotation_coeficent")
    .min(-10)
    .max(10)
    .step(0.01)
    .name("rotate_coef")
  ...
  text3DebugFolder
    .add(settings, "text_3_position_x")
    .min(-10)
    .max(10)
    .step(0.01)
    .name("x")
  ...
  text3DebugFolder
    .add(settings, "text_3_position_y")
    .min(-10)
    .max(10)
    .step(0.01)
    .name("y")
  ...
  text3DebugFolder
    .add(settings, "text_3_position_z")
    .min(-10)
    .max(10)
    .step(0.01)
    .name("z")
  ...
  text3DebugFolder
    .add(settings, "text_3_rotation_coeficent")
    .min(-10)
    .max(10)
    .step(0.01)
    .name("rotate_coef")
  ...
  text4DebugFolder
    .add(settings, "text_4_position_x")
    .min(-10)
    .max(10)
    .step(0.01)
    .name("x")
  ...
  text4DebugFolder
    .add(settings, "text_4_position_y")
    .min(-10)
    .max(10)
    .step(0.01)
    .name("y")
  ...
  text4DebugFolder
    .add(settings, "text_4_position_z")
    .min(-10)
    .max(10)
    .step(0.01)
    .name("z")
  ...
  text4DebugFolder
    .add(settings, "text_4_rotation_coeficent")
    .min(-10)
    .max(10)
    .step(0.01)
    .name("rotate_coef")
  ...
  text5DebugFolder
    .add(settings, "text_5_position_x")
    .min(-10)
    .max(10)
    .step(0.01)
    .name("x")
  ...
  text5DebugFolder
    .add(settings, "text_5_position_y")
    .min(-10)
    .max(10)
    .step(0.01)
    .name("y")
  ...
  text5DebugFolder
    .add(settings, "text_5_position_z")
    .min(-10)
    .max(10)
    .step(0.01)
    .name("z")
  ...
  text5DebugFolder
    .add(settings, "text_5_rotation_coeficent")
    .min(-10)
    .max(10)
    .step(0.01)
    .name("rotate_coef")
...
export function openLevel2Page(settings, scene) {
  ...
  if (
     ...
     * Background closer
     */
    const closer_b = document.querySelector("#pages_level_2_closer");
    closer_b.style.left = 0;
    closer_b.addEventListener("click", () => {
    ...
    const page_to_show = document.querySelector(
      "#" + settings.active_text_group_level_2_name
    );
    ...
    if (!settings.mobile_version) {
      ...
      camera_animation = new TWEEN.Tween(camera.position)
        .to({ x: 2, y: camera.position.y, z: camera.position.z }, 500)
        .easing(TWEEN.Easing.Sinusoidal.Out)
        .start();
    }
    ...
    const text_active_obj = scene.getObjectByName(
      settings.active_text_group_level_2_name
    );

    const name_x_position =
      settings.active_text_group_level_2_name + "_position_x";
    const name_y_position =
      settings.active_text_group_level_2_name + "_position_y";
    const name_z_position =
      settings.active_text_group_level_2_name + "_position_z";

    old_active_group_place = {
      x: settings[name_x_position],
      y: settings[name_y_position],
      z: settings[name_z_position],
    };
    old_active_group_name = text_active_obj.name;

    new TWEEN.Tween(text_active_obj.scale)
      .to({ x: 2, y: 2, z: 2 }, 300)
      .start();
    new TWEEN.Tween(text_active_obj.position)
      .to({ x: -1.5, y: -1, z: 1 }, 300)
      .start();
    ...
    new TWEEN.Tween(cursor_group.position)
...
export function closeLevel2Page(settings, scene) {
   ...
   */
  const closer_b = document.querySelector("#pages_level_2_closer");
  closer_b.style.left = "-100vw";
  closer_b.removeEventListener("click", () => {
    closeLevel2Page(settings, scene);
  });
  ...
  if (!settings.mobile_version) {
    ...
    camera_animation = new TWEEN.Tween(camera.position)
      .to({ x: 0, y: camera.position.y, z: camera.position.z }, 500)
      .start()
      .onComplete(() => {
