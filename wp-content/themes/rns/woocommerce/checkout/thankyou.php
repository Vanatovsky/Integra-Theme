...
<br /><br />
<div class="rf-container rf-woo-thankyou">

	<!-- <a style="margin-bottom:30px;display:table;" href="/cabinet/" class="rf-btn rf-btn-primary">Перейти в личный кабинет »</a> -->

	<div class="woocommerce-order rf-thank-for-order">
		...
		?>
			...
			<?php else : ?>
				...
				<p>Информация о заказе отправлена на указанную при оформлении электронную почту.</p>
